  ...
  return (
    <Router>
      <div style={styles.app}>
        {/* Logo 组件中传递 setAccount 和 setWeb3 来处理钱包连接 */}
        ...
        <div style={styles.content}>
          <Routes>
            ...
            <Route path="/mining" element={<Mining account={account} web3={web3} contract={contract} />} />  {/* 传递 account, web3, contract */}
